...
Component.prototype.createOperations = function()
{
    try {
        ...
        if (systemInfo.productType === "windows") {
            component.addOperation ("CreateShortcut", "@TargetDir@/bin/KiCadToFactory.exe", "@StartMenuDir@/KiCadToFactory.lnk",
...
Component.prototype.dynamicPageEntered = function ()
{
    ...
    if (pageWidget != null) {
        ...
        pageWidget.textContent.setText ("<b>KiCadToFactory</b> is a tool to convert KiCad position and BOM file to factory required format.<br>"
         + "<br>"
